 ...
 */
package org.spacebar.escape.midp2;
...
import org.spacebar.escape.midp1.Backgrounder;
import org.spacebar.escape.midp1.ResourceUtil;

/**
 * @author adam
 */
public class EscapeDrawer implements CommandListener {
    ...
    EscapeDrawer(byte[] level, MIDlet m, Continuation c) {
        theApp = m;
        theWayOut = c;
