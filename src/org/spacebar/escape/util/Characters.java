...
public class Characters {
    ...
    public static final String FONTCHARS = " ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789`-=[]\\;',./~!@#$%^&*()_+{}|:\"<>?" + CHECKMARK + ESC + HEART + LCMARK1 + LCMARK2 + BAR_0 + BAR_1 + BAR_2 + BAR_3 + BAR_4 + BAR_5 + BAR_6 + BAR_7 + BAR_8 + BAR_9 + BAR_10 + BARSTART;
